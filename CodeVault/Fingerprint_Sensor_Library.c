/**
 * @file FingerprintSensor.c
 * @brief Implementation of the library for interfacing with the Adafruit Fingerprint Sensor on an STM32F4 microcontroller.
 * 
 * This file contains the implementation of the functions declared in FingerprintSensor.h.
 * It handles the initialization of the UART interface, communication with the fingerprint sensor,
 * and execution of various fingerprint operations including capturing images, creating models, 
 * and searching for fingerprint IDs.
 * 
 * Features:
 ...
 * - LED Control: Functions to control the onboard LED of the fingerprint sensor.
 * 
 * Created by Kiran Jojare in December 2023.
 */
