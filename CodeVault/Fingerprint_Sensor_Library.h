/**
 * @file FingerprintSensor.h
 * @brief Library for interfacing with the Adafruit Fingerprint Sensor on an STM32F4 microcontroller.
 * 
 * This library provides functions to initialize the UART interface, capture fingerprint images, 
 * convert images to templates, create and store fingerprint models, search for fingerprint IDs, 
 * and manage the fingerprint database (enrollment, deletion, and clearing).
 * 
 * Features:
